"""
File: Speculator for division errors, implementing VSOps-All algorithm.
...
from .vsops_abc import VspecAllBaseSpeculator
...
class VspecAllDIVSpeculator(VspecAllBaseSpeculator):
